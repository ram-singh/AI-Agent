...
def create_agents(llm: ChatOpenAI, tools: list, system_prompt: str) -> AgentExecutor:
    """Create an agent executor with the specified tools."""
...
ads_writer_agent = create_agents(
    llm, tools,
    ...
    """)
ads_writer_node = functools.partial(
    agent_node, agent=ads_writer_agent, name="ads_writer")
